...
### Website
- Login email: `nstung@gmail.com`
- Login password: `5TlHi&G^v$`

### Supabase
```env
NEXT_PUBLIC_SUPABASE_URL=https://syzyagwwhjwfwjfmgrpy.supabase.co
NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY=sb_publishable_gftR9Uy_8JzjDZG91i2WkQ_J7MpYC7p
DATABASE_URL=postgresql://postgres:BdX03DxYm3$@db.syzyagwwhjwfwjfmgrpy.supabase.co:5432/cozyclone
```
---
